...
public class Adp_Perimeter extends RecyclerView.Adapter<Adp_Perimeter.ViewHolder> {

    private Context mContext;
    List<Mod_Perimeter> mLinks;

    FloatingActionButton popclos;
    ImageView popimg;
    Dialog myDialog;

    public Adp_Perimeter(Context mContext, List<Mod_Perimeter> mLinks) {
